    """
    Topic Modeller 38aeaug4
    =======================
    Developer-friendly AI library that helps you process documents programmatically.
    ...
    APP_NAME    = "Topic Modeller 38aeaug4"
    APP_VERSION = "1.0.0"
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly AI library that helps you process documents programmatically.")
